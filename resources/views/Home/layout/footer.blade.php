      ...
      <div class="footer-content">
        <div class="footer-content-column">
          <div class="footer-logo">
            <span class="footer-logo-link" href="#">
              <span class="hidden-link-text" style="color: white;"></span>
              <h1 style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">RideReserve</h1>
          </span>
          </div>
      ...
      <div class="footer-copyright">
        <div class="footer-copyright-wrapper">
          <p class="footer-copyright-text">
            <a class="footer-copyright-link" href="" target="_self"> ©2025. | Designed By: Buthena Abdullah. | All rights reserved. </a>
          </p>
        </div>
      </div>
    </footer>
